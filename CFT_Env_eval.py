# -*- coding: utf-8 -*-
"""
Created on Tue Jul 25 11:06:22 2023
...
class CFT_Env_Eval(gym.Env):
    ...
    def __init__(self,
        ...
        super(CFT_Env_Eval, self).__init__()
        ...
        self.err_analyitc_list = ising_viol_20()
    ...
    def step(self, action):
        ...
        if self.step_num == self.ep_steps:
            ...
            with open(f'Rewards_Neuron:{self.neurons}_Eval.csv', 'ab') as file:
                np.savetxt(file, self.Reward_collector)
                
            file = open(f'Best_with_maxreward_Neuron:{self.neurons}_Eval.csv',mode='a')
